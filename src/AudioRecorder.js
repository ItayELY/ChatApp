...
function AudioRecorder(props) {
    ...
    var initializeGlobals = () => {
        ...
        audioElementSource = document.getElementsByClassName("audio-element")[0].getElementsByTagName("source")[0];
        textIndicatorOfAudiPlaying = document.getElementsByClassName("text-indication-of-audio-playing")[0];
    };
    //Listeners
    var initializeListeners = () => {
        console.log('initializeListeners: ', initializeListeners);
    ...
    function stopAudioRecording() {
        ...
        audioRecorder.stop()
            .then(audioAsblob => {
                //Play recorder audio
                sendAudioMessageChatapp(audioAsblob);
    ...
    */
    ...
    return (
        <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasAudioRecord" aria-labelledby="offcanvasBottomLabel">
            ...
            <div class="audio-recording-container">
                ...
                <div class="recording-contorl-buttons-container hide">
                    ...
                    <i class="stop-recording-button fa fa-stop-circle-o" aria-hidden="true">stop</i>
                </div>
